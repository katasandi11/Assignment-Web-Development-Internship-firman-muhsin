        ...
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand">
                ...
                <a href="#">
                    <b class="logo-icon">
                        <!-- Dark Logo icon -->
                        <img src="partials/logo_lokatani.png" width="250" height="50" alt="homepage" class="dark-logo" />
                        <!-- Light Logo icon -->
                        <img src="partials/logo_lokatani.png" width="250" height="50" alt="homepage" class="light-logo" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav float-left mr-auto ml-3 pl-1">
                ...
                <li class="nav-item dropdown">
                    <p class="ml-3 mt-4">Hi, Have a nice day! </p>
                </li>
            </ul>
            <!-- ============================================================== -->
                                ...
                                <!-- javascript:void(0) -->
                                     <a href="notifcomplaint.php" class="message-item d-flex align-items-center border-bottom px-3 py-2"> 
                                        ...
                                        <div class="w-75 d-inline-block v-middle pl-2">
                                            <h6 class="message-title mb-0 mt-1">Hi, You have notifications !</h6>
                ...
                <!-- ============================================================== -->
                 <!-- <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" style="pointer-events: none;" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="d-none d-lg-inline-block"><span class="text-dark">Hello, </span>
                    </a>
                </li> -->
                <!-- ============================================================== -->
                <!-- User profile and search -->
